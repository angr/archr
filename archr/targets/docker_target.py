...
class DockerImageTarget(Target):
    ...
    def build(self, pull=False):  # pylint:disable=arguments-differ
        ...
        self.target_args = self.target_args or (self.image.attrs["Config"]["Entrypoint"] or []) + (
            self.image.attrs["Config"]["Cmd"] or []
        )
        ...
        self.target_path = (
            ...
            else os.path.realpath(os.path.join(self.target_cwd, specified_path))
        )
